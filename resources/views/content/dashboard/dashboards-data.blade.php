                                    ...
                                    <div class="actions">
                                        ...
                                        <div class="dropdown-menu">
                                            <a id="set_dtl" class="btn btn-default dropdown-item" data-bs-toggle="modal"
                                                ...
                                                data-tanggaldibuat="<?= $data->tanggaldibuat ?>"
                    ...
                    <table class="table table-bordered no-margin">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span id="tanggaldibuat"></span></td>
                            </tr>
                            <tr>
                                <th>Status</th>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '#set_dtl', function() {
                ...
                var tanggaldibuat = $(this).data('tanggaldibuat');
                var status = $(this).data('status');
                $('#nomorsurat').text(nomorsurat);
                $('#dibuatoleh').text(dibuatoleh);
                $('#perihal').text(perihal);
                $('#deskripsi').text(deskripsi);
                $('#tanggaldibuat').text(tanggaldibuat);
                $('#status').text(status);
            });
